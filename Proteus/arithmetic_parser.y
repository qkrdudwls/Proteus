...
%token <ival> ARITHMETIC_DIGIT ARITHMETIC_PLUS ARITHMETIC_MINUS ARITHMETIC_MULT ARITHMETIC_DIV ARITHMETIC_EXP ARITHMETIC_MOD ARITHMETIC_LPAREN ARITHMETIC_RPAREN ARITHMETIC_NEWLINE ARITHMETIC_UMINUS

%type <ival> input infix_expr prefix_expr postfix_expr
...
%nonassoc ARITHMETIC_UNMINUS

%%

input : ARITHMETIC_PREFIX prefix_expr ARITHMETIC_NEWLINE { printf("Original Result: %d\n", $2); yylval.ival = $2; }
...
infix_expr : infix_expr ARITHMETIC_PLUS infix_expr { $$ = $1 + $3; }
...
prefix_expr : ARITHMETIC_PLUS prefix_expr prefix_expr { $$ = $2 + $3; }
     ...
     | ARITHMETIC_MINUS prefix_expr %prec ARITHMETIC_UMINUS { $$ = -$2; }
     | ARITHMETIC_DIGIT { $$ = $1; }
     ;
