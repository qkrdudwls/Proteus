...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL___DIGIT__ = 3,                  /* __DIGIT__  */
  YYSYMBOL_4_ = 4,                         /* '-'  */
  YYSYMBOL_5_ = 5,                         /* '+'  */
  YYSYMBOL_6_ = 6,                         /* '*'  */
  YYSYMBOL_7_ = 7,                         /* '/'  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "__DIGIT__", "'-'",
  "'+'", "'*'", "'/'", "UMINUS", "'\\n'", "'('", "')'", "$accept", "line",
  "expr", YY_NULLPTR
};
...
#line 27 "parser.y"
                     { yyval = yyvsp[-2] / yyvsp[0]; if(yyvsp[0] == 0) yyerror("Division by zero"); }
