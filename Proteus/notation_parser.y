...
%type <node> input preorder_expr inorder_expr postorder_expr
...
preorder_expr:
    ...
    | NOTATION_LPAREN preorder_expr NOTATION_RPAREN { $$ = $2; }
    | NOTATION_MINUS preorder_expr %prec NOTATION_UMINUS { $$ = createNode('u', 1, $2, NULL); }
    | NOTATION_DIGIT { $$ = createLeaf($1); }
    ;
